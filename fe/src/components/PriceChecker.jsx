                            ...
                            <div className="flex justify-between items-start mb-2">
                                <div>
                                    <h4 className="font-bold text-lg capitalize flex items-center gap-2">
                                        {result.crop}
                                        {result.isCached && (
                                            <span className="flex items-center gap-1 text-xs bg-black/5 text-stone-500 px-2 py-0.5 rounded-full font-normal" title="Cached data">
                                                <Info className="h-3 w-3" /> Cached
                                            </span>
                                        )}
                                        {result.isFallback && (
                                            <span className="flex items-center gap-1 text-xs bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full font-normal" title="Estimated based on mock data">
